...
| M2 首轮排序与选择 | IN_PROGRESS | 2/5 | M2-T01 EmbeddingProvider 与真实 BGE-M3 已验证；M2-T02 RerankerProvider、固定 BGE reranker、真实 33 候选排序与完成证据已验证；下一任务 M2-T03 |
